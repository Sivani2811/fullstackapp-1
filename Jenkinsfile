pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.211.215.35:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Sivani2811/fullstackapp-1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.211.215.35:9090/springapp1"
            echo "✅ Frontend deployed: http://54.211.215.35:9090/frontapp1"
        }
        failure {
